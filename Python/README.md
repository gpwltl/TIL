...
- [자료형, 연산자](https://github.com/gpwltl/TIL/blob/master/Python/syntax/practice.py)
- [함수](https://github.com/gpwltl/TIL/blob/master/Python/syntax/functionn.py)
- [숫자 처리 함수](https://github.com/gpwltl/TIL/blob/master/Python/syntax/function_num.py)
...
- [클래스](https://github.com/gpwltl/TIL/blob/master/Python/syntax/class.py)
- [상속](https://github.com/gpwltl/TIL/blob/master/Python/syntax/Inheritance.py)
- [정렬 sort, sorted](https://github.com/gpwltl/TIL/blob/master/syntax/Python/sort.md)
...
- [itertools](https://github.com/gpwltl/TIL/blob/master/Python/syntax/itertools.md)
